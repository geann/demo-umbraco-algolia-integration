...
namespace DemoUmbracoAlgoliaIntegration.Handlers;

public class DemoAlgoliaNotificationHandler : INotificationAsyncHandler<ContentCacheRefresherNotification> 
{
    private readonly IServerRoleAccessor _serverRoleAccessor;
        ...
        public DemoAlgoliaNotificationHandler(
            ...
            IUmbracoContextFactory umbracoContextFactory) : base()
        {
        ...
        protected async Task RebuildIndex(IEnumerable<IContent> entities)
        {
            try
            {
                ...
                {
                    var hideFromSearch = entity.Properties.FirstOrDefault(p => p.Alias == "hideFromSearch")?.Values
                        .Any(v => v.PublishedValue?.Equals(1) ?? false) ?? false;
                    foreach (var index in indices)
                    {
                        ...
                        var result = entity.Trashed || !entity.Published || hideFromSearch
